 ...
 */
package com.l2jserver.datapack.ai.npc.FortressSteward.NarsellFortSteward;
...
* @version 2.6.3.0
*/
public class NarsellFortSteward extends FortressSteward {
	
	private static final TelPosList[] _position1 = new TelPosList[] {
		new TelPosList(1010656, new Location(153112, 56872, -3256), 0),
		new TelPosList(1010657, new Location(156730, 53921, -3256), 0),
	...
	private static final int npcId = 35827;
	
	public NarsellFortSteward() {
		super(npcId);
