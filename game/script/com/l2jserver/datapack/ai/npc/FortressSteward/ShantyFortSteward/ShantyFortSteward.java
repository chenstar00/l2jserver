 ...
 */
package com.l2jserver.datapack.ai.npc.FortressSteward.ShantyFortSteward;
...
* @version 2.6.3.0
*/
public class ShantyFortSteward extends FortressSteward {
	
	private static final TelPosList[] _position1 = new TelPosList[] {
		new TelPosList(1010656, new Location(-55240, 157193, -2048), 0),
		new TelPosList(1010657, new Location(-50296, 155793, -2056), 0),
	...
	private static final int npcId = 35658;
	
	public ShantyFortSteward() {
		super(npcId);
