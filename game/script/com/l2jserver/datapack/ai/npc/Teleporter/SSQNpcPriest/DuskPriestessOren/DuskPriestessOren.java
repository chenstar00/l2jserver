 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessOren;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessOren extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010080, new Location(74672, 78032, -3398), 3000)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010080, new Location(74672, 78032, -3398), 5000)
	};
	...
	private static final int npcId = 31090;
	
	public DuskPriestessOren() {
		super(npcId);
