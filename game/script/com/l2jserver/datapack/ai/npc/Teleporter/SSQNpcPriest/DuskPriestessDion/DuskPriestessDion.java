 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessDion;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessDion extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010071, new Location(45600, 126944, -3686), 2300),
		new TelPosList(1010078, new Location(39232, 143568, -3651), 1500),
		new TelPosList(1010079, new Location(43200, 170688, -3251), 3500),
		new TelPosList(1010072, new Location(107514, 174329, -3704), 6800)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010071, new Location(45600, 126944, -3686), 3900),
		new TelPosList(1010078, new Location(39232, 143568, -3651), 2600),
		new TelPosList(1010079, new Location(43200, 170688, -3251), 5900),
		new TelPosList(1010072, new Location(107514, 174329, -3704), 11000)
	};
	...
	private static final int npcId = 31087;
	
	public DuskPriestessDion() {
		super(npcId);
