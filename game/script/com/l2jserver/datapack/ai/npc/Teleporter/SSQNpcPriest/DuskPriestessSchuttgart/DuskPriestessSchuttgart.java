 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessSchuttgart;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessSchuttgart extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010070, new Location(-41184, 206752, -3357), 17000),
		new TelPosList(1010071, new Location(45600, 126944, -3686), 19000),
		new TelPosList(1010078, new Location(39232, 143568, -3651), 20000),
		new TelPosList(1010079, new Location(43200, 170688, -3251), 30000),
		new TelPosList(1010072, new Location(107514, 174329, -3704), 22000),
		new TelPosList(1010080, new Location(74672, 78032, -3398), 26000),
	...
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010070, new Location(-41184, 206752, -3357), 29000),
		new TelPosList(1010071, new Location(45600, 126944, -3686), 32000),
		new TelPosList(1010078, new Location(39232, 143568, -3651), 34000),
		new TelPosList(1010079, new Location(43200, 170688, -3251), 50000),
		new TelPosList(1010072, new Location(107514, 174329, -3704), 38000),
		new TelPosList(1010080, new Location(74672, 78032, -3398), 44000),
		new TelPosList(1010073, new Location(-25472, 77728, -3446), 49000)
	};
	...
	private static final int npcId = 31998;
	
	public DuskPriestessSchuttgart() {
		super(npcId);
