 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessAden;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessAden extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010076, new Location(168560, -17968, -3174), 8400),
		new TelPosList(1010081, new Location(136672, 79328, -3702), 7500),
		new TelPosList(1010083, new Location(110912, 84912, -4816), 11000)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010076, new Location(168560, -17968, -3174), 14000),
		new TelPosList(1010081, new Location(136672, 79328, -3702), 12000),
		new TelPosList(1010083, new Location(110912, 84912, -4816), 18000)
	};
	...
	private static final int npcId = 31091;
	
	public DuskPriestessAden() {
		super(npcId);
