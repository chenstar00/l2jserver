 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.Teranu;
 ...
 * @version 2.6.3.0
 */
public class Teranu extends Teleporter {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010199, new Location(148024, -55281, -2728), 4000),
		new TelPosList(1010200, new Location(43835, -47749, -792), 6400),
		new TelPosList(1010568, new Location(165054, -47861, -3560), 6800),
		new TelPosList(1010609, new Location(144880, -113468, -2560), 11000)
	};
	
	private static final TelPosList[] _positionForFriend = new TelPosList[] {
		new TelPosList(1010199, new Location(148024, -55281, -2728), 4000),
		new TelPosList(1010200, new Location(43835, -47749, -792), 6400),
		new TelPosList(1010023, new Location(146783, 25808, -2000), 8700),
		new TelPosList(1010574, new Location(87126, -143520, -1288), 9300),
		new TelPosList(1010568, new Location(165054, -47861, -3560), 6800),
		new TelPosList(1010609, new Location(144880, -113468, -2560), 11000)
	};
	...
	private static final int friendShip1 = 7221;
	private static final int friendShip2 = 7222;
	private static final int friendShip3 = 7223;
	private static final int friendShip4 = 7224;
	private static final int friendShip5 = 7225;
	
	private static final String fnHi = fnPath + "teranu001.htm";
	private static final String fnNoFriend = fnPath + "teranu009.htm";
	private static final String fnForFriendNormal = fnPath + "teranu008.htm";
	private static final String fnForFriendSpecial = fnPath + "teranu007.htm";
	...
	private static final int npcId = 31383;
