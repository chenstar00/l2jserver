 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessGodard;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessGodard extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010076, new Location(168560, -17968, -3174), 7100),
		new TelPosList(1010083, new Location(110912, 84912, -4816), 24000),
		new TelPosList(1010082, new Location(-22480, 13872, -3174), 31000),
		new TelPosList(1010077, new Location(79296, 209584, -3709), 46000)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010076, new Location(168560, -17968, -3174), 11000),
		new TelPosList(1010083, new Location(110912, 84912, -4816), 40000),
		new TelPosList(1010082, new Location(-22480, 13872, -3174), 51000),
		new TelPosList(1010077, new Location(79296, 209584, -3709), 76000)
	};
	...
	private static final int npcId = 31693;
	
	public DuskPriestessGodard() {
		super(npcId);
