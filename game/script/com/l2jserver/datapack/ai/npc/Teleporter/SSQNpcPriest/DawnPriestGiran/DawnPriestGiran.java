 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DawnPriestGiran;
 ...
 * @version 2.6.3.0
 */
public class DawnPriestGiran extends SSQNpcPriest {
	...
	private static final int npcId = 31081;
	
	public DawnPriestGiran() {
		super(npcId);
