 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.Minevea;
...
public class Minevea extends Teleporter {
	...
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010007, new Location(83551, 147945, -3400), 4400),
		new TelPosList(1010013, new Location(82971, 53207, -1470), 6100),
		new TelPosList(1010020, new Location(117088, 76931, -2670), 3400)
	};
	...
	private static final int npcId = 30836;
