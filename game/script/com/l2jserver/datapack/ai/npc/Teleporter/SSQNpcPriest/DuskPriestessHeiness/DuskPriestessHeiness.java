 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessHeiness;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessHeiness extends SSQNpcPriest {
	...
	private static final int npcId = 31089;
	
	public DuskPriestessHeiness() {
		super(npcId);
