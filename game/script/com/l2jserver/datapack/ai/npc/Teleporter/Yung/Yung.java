 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.Yung;
 ...
 * @version 2.6.3.0
 */
public class Yung extends Teleporter {
	...
	private static final int npcId = 32186;
	...
	public void onMenuSelected(PlayerMenuSelected event) {
		...
		if (talker.getKarma() > 0) {
			showPage(talker, fnPath + "yung003.htm");
			return;
		}
		if (talker.getLevel() > higher_lv) {
			showPage(talker, fnPath + "yung005.htm");
			return;
		}
