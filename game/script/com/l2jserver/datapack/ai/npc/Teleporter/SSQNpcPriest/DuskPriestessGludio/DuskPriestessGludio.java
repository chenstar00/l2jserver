 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessGludio;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessGludio extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010073, new Location(-25472, 77728, -3446), 5500),
		new TelPosList(1010074, new Location(-56064, 78720, -3011), 8700),
		new TelPosList(1010070, new Location(-41184, 206752, -3357), 4200),
		new TelPosList(1010082, new Location(-22480, 13872, -3174), 18000)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010073, new Location(-25472, 77728, -3446), 9200),
		new TelPosList(1010074, new Location(-56064, 78720, -3011), 14000),
		new TelPosList(1010070, new Location(-41184, 206752, -3357), 7000),
		new TelPosList(1010082, new Location(-22480, 13872, -3174), 30000)
	};
	...
	private static final int npcId = 31086;
	
	public DuskPriestessGludio() {
		super(npcId);
