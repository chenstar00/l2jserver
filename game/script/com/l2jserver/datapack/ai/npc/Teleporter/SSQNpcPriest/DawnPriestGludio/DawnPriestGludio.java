 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DawnPriestGludio;
 ...
 * @version 2.6.3.0
 */
public class DawnPriestGludio extends SSQNpcPriest {
	...
	private static final int npcId = 31079;
	
	public DawnPriestGludio() {
		super(npcId);
