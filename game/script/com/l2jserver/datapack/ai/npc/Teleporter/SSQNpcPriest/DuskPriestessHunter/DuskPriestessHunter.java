 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessHunter;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessHunter extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010081, new Location(136672, 79328, -3702), 3000),
		new TelPosList(1010083, new Location(110912, 84912, -4816), 1700)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010081, new Location(136672, 79328, -3702), 5000),
		new TelPosList(1010083, new Location(110912, 84912, -4816), 2800)
	};
	...
	private static final int npcId = 31169;
	
	public DuskPriestessHunter() {
		super(npcId);
