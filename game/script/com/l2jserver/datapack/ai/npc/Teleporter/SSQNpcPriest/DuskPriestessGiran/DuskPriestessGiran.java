 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.SSQNpcPriest.DuskPriestessGiran;
 ...
 * @version 2.6.3.0
 */
public class DuskPriestessGiran extends SSQNpcPriest {
	
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010075, new Location(114496, 132416, -3101), 5100)
	};
	
	private static final TelPosList[] _positionCompetition = new TelPosList[] {
		new TelPosList(1010075, new Location(114496, 132416, -3101), 8600)
	};
	...
	private static final int npcId = 31088;
	
	public DuskPriestessGiran() {
		super(npcId);
