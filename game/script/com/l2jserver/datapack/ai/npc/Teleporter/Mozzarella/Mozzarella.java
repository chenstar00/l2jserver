 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.Mozzarella;
 ...
 * @version 2.6.3.0
 */
public class Mozzarella extends Teleporter {
	
	private static final int npcId = 30483;
	
	private static final int _higherLvl = 56;
	...
	public void onTeleportRequest(PlayerTeleportRequest event) {
		...
		if (talker.getLevel() >= _higherLvl) {
			showPage(talker, fnPath + "mozzarella005.htm");
			return;
		}
