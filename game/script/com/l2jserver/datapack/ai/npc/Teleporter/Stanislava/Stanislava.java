 ...
 */
package com.l2jserver.datapack.ai.npc.Teleporter.Stanislava;
...
public class Stanislava extends Teleporter {
	...
	private static final TelPosList[] _position = new TelPosList[] {
		new TelPosList(1010494, new Location(38303, -48040, 896), 150)
	};
	
	private static final TelPosList[] _positionNoblessNeedItemField = new TelPosList[] {
		new TelPosList(1010494, new Location(38316, -48216, -1152), 1)
	};
	
	private static final TelPosList[] _positionNoblessNoItemField = new TelPosList[] {
		new TelPosList(1010494, new Location(38316, -48216, -1152), 1000)
	};
	
	private static final int npcId = 31699;
